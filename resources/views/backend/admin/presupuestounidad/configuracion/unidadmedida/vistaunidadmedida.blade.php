...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('/admin/p/unidadmedida/tabla') }}";
    ...
    <script>
        ...
        function recargar(){
            var ruta = "{{ url('/admin/p/unidadmedida/tabla') }}";
            $('#tablaDatatable').load(ruta);
        }
        ...
        function nuevo(){
            ...
            formData.append('nombre', medida);

            axios.post(url+'/p/unidadmedida/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function informacion(id){
            ...
            axios.post(url+'/p/unidadmedida/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success === 1){
                        ...
                        $('#id-editar').val(id);
                        $('#medida-editar').val(response.data.lista.nombre);
        ...
        function editar(){
            ...
            axios.post(url+'/p/unidadmedida/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
