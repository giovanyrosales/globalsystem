...
<div id="divcontenedor" style="display: none">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Listado de Tipo de Garantias</li>
                </ol>
            </div>
        </div>
    </section>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Nuevo Tipo de Garantía</h4>
    ...
    <div class="modal fade" id="modalEditar">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Editar Tipo de Garantía</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('/admin/tesoreria/tipo/garantia/tabla') }}";
    ...
    <script>
        ...
        function recargar(){
            var ruta = "{{ url('/admin/tesoreria/tipo/garantia/tabla') }}";
            $('#tablaDatatable').load(ruta);
        }
        ...
        function nuevo(){
            ...
            if(nombre === ''){
                toastr.error('Tipo de Garantía es requerido');
                return;
            }
            ...
            axios.post(url+'/tesoreria/tipo/garantia/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function informacion(id){
            ...
            axios.post(url+'/tesoreria/tipo/garantia/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post(url+'/tesoreria/tipo/garantia/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
