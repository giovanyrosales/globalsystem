        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Listado de Garantias</li>
                </ol>
            </div>
        </div>
    </section>
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('/admin/tesoreria/garantia/tabla') }}";
    ...
    <script>
        ...
        function recargar(){
            var ruta = "{{ url('/admin/tesoreria/garantia/tabla') }}";
            $('#tablaDatatable').load(ruta);
        }
        ...
        function nuevo(){
            ...
            if(nombre === ''){
                toastr.error('Garantía es requerido');
                return;
            }
        ...
        function informacion(id){
            ...
            axios.post(url+'/tesoreria/garantia/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post(url+'/tesoreria/garantia/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
