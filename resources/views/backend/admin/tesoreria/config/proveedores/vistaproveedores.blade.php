...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('/admin/tesoreria/proveedores/tabla') }}";
    ...
    <script>
        ...
        function recargar(){
            var ruta = "{{ url('/admin/tesoreria/proveedores/tabla') }}";
            $('#tablaDatatable').load(ruta);
        }
        ...
        function informacion(id){
            ...
            axios.post(url+'/tesoreria/proveedores/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post(url+'/tesoreria/proveedores/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
