...
<div id="divcontenedor" style="display: none">
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Listado Completados</li>
                </ol>
            </div>
        </div>
    </section>
        ...
        <div class="container-fluid">
            <div class="card card-gray">
                <div class="card-header">
                        <h3 class="card-title">Listado UCP completados</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            var ruta = "{{ url('/admin/tesoreria/listado-ucp-completados/tabla/index') }}/" + anioActual + "/" + 0; // 0: TODOS LOS MESES
        ...
        function buscarTabla(){
            ...
            var ruta = "{{ url('/admin/tesoreria/listado-ucp-completados/tabla/index') }}/" + anio + "/" + meses;
            $('#tablaDatatable').load(ruta);
        }
        ...
        function recargarAnioTodos(){
            ...
            var ruta = "{{ url('/admin/tesoreria/listado-ucp/tabla/index') }}/" + anioActual + "/" + 0; // 0: TODOS LOS MESES
            $('#tablaDatatable').load(ruta);
        }
