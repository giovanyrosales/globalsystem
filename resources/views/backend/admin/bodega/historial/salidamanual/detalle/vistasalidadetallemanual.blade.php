        ...
        <div class="container-fluid">
            <div class="card card-gray-dark">
                <div class="card-header">
                    <h3 class="card-title">Listado Detalle</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            let id = {{ $id }};
            var ruta = "{{ URL::to('/admin/bodega/historial/salidamanualdetalle/tabla') }}/" + id;
    ...
    <script>
        ...
        function borrarRegistro(id){
            ...
            axios.post(url+'/bodega/salidasmanual/borraritem', formData, {
            })
                .then((response) => {
                    closeLoading();
